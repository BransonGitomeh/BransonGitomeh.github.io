...
var KTypeahead = function() {
    ...
    var demo1 = function() {
        ...
        $('#k_typeahead_1, #k_typeahead_1_modal, #k_typeahead_1_validate, #k_typeahead_2_validate, #k_typeahead_3_validate').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        }, {
    ...
    var demo2 = function() {
        ...
        $('#k_typeahead_2, #k_typeahead_2_modal').typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        },
    ...
    var demo3 = function() {
        ...
        // options being used
        $('#k_typeahead_3, #k_typeahead_3_modal').typeahead(null, {
            name: 'countries',
            source: countries
        });
    }
